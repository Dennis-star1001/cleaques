        ...
        <Box bg='#E1EEF3' p='20'>
            <Flex gap='10'>
                ...
                <Text px='5' py='5' fontSize={'20'} fontWeight={'500'}>Event</Text>
                    <Flex  alignItems={'center'} gap='5' bg='#E1EEF3' p='5' mx='10' >
                        ...
                        <Flex justifyContent={'space-between'} w='full'>
                            <Flex flexDirection={'column'} gap='3'>
                                <Text fontSize={'24'} fontWeight={'500'} color='#00B0F3'>State Music Award</Text>
                                <Flex gap='5'>
                                    <Flex>
                            ...
                            <Flex flexDirection={'column'} gap='3' textAlign={'center'}>
                                ...
                                <Text fontWeight={'600'} fontSize={'md'}>FREE</Text>
                            </Flex>
                        </Flex>
                    </Flex>
                    <Flex  alignItems={'center'} gap='5' bg='#E1EEF3' p='5' mx='10' >
                    ...
                    </Flex> <Flex  alignItems={'center'} gap='5' bg='#E1EEF3' p='5' mx='10' >
                        <Image
                            w='200px'
                            h='120px'
                            src='https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'
